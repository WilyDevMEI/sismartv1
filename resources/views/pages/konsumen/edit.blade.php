@extends('layouts.dashboard', ['title' => 'Edit Data Konsumen', 'state' => 'konsumen', 'page' => 'konsumen'])
@section('content')
    <section id="detail-konsumen">
        ...
        <div class="wrapper-form bg-white p-md-5 p-3 rounded-4 mt-5 mb-sm-5 mb-3">
            <form action="{{ route('konsumen.update', $konsuman->id) }}" method="POST" class="needs-validation" novalidate>
                @method('PUT')
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="email" name="email" autocomplete="off"
                            spellcheck="false" placeholder="Enter email company" required value="{{ $konsuman->email }}">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="description_company" name="description_company"
                            placeholder="Enter description company" rows="6" required>{{ $konsuman->description_company }}</textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pkp" name="pkp" autocomplete="off"
                            spellcheck="false" placeholder="Enter PKP customer" required value="{{ $konsuman->pkp }}">
                    </div>
                </div>
                <div class="row mb-5">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="npwp" name="npwp" autocomplete="off"
                            spellcheck="false" placeholder="Enter NPWP customer" required value="{{ $konsuman->npwp }}">
                    </div>
                </div>
