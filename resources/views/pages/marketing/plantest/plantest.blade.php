    ...
    <section id="product">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Plantest</li>
            </ol>
        </nav>
        <h2>Menu Plantest</h2>
        ...
        <div class="wrapper-form bg-white p-md-5 p-3 rounded-4 mt-5 mb-sm-5 mb-3">
            ...
            @endif
            <form action="{{ route('plantest.store') }}" method="POST" class="needs-validation" novalidate>
                @csrf
                <h3 class="text-muted mb-4">New Plantest</h3>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="date_plantest" name="date_plantest"
